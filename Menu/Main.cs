...
namespace StupidTemplate.Menu
{
    ...
    RoundCornerD
        ...
        {
            if (EasyInputs.GetTriggerButtonFloat(EasyHand.RightHand) > 0.1f && !rightTriggerPressed)
            {
                Toggle("NextPage");
                rightTriggerPressed = true;  
            }
            else if (EasyInputs.GetTriggerButtonFloat(EasyHand.RightHand) <= 0.1f)
            {
        ...
        {
            if (EasyInputs.GetTriggerButtonFloat(EasyHand.LeftHand) > 0.1f && !leftTriggerPressed)
            {
                Toggle("PreviousPage");
                leftTriggerPressed = true;  
            }
            else if (EasyInputs.GetTriggerButtonFloat(EasyHand.LeftHand) <= 0.1f)
            {
